...
void init(){
	...
	table.footer = "6 usuarios";

	table.addrow("Codigo", 10);
	table.addrow("Nombre", 30);
	table.addrow("Edad", 5);

	std::vector<std::string> cols;
	cols.push_back("11111");
	cols.push_back("Jimmy Josue");
	cols.push_back("22");
	table.addcolumn(cols);
	cols.clear();

	cols.push_back("22222");
	cols.push_back("");
	cols.push_back("25");
	table.addcolumn(cols);
	cols.clear();

	cols.push_back("33333");
	cols.push_back("Johana Stefany");
	cols.push_back("30");
	table.addcolumn(cols);
	cols.clear();

	cols.push_back("44444");
	cols.push_back("Antony");
	cols.push_back("90");
	table.addcolumn(cols);
	cols.clear();

	cols.push_back("55555");
	cols.push_back("Juan Carlos");
	cols.push_back("40");
	table.addcolumn(cols);
	cols.clear();

	cols.push_back("66666");
	cols.push_back("Jimmy Chullunquia Quispe");
	cols.push_back("70");
	table.addcolumn(cols);
	cols.clear();
	table.start();
